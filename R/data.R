...
#' \describe{
#'   \item{nparams}{the number of actual problem parameters, i.e. resistivities
#'   at interesting ground layers (air is considered separately)}
#'   \item{nqoi}{the number of quantities of interest (QOI), i.e. impedances
#'   at receivers}
